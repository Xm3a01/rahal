(function ($) {
    ...
    $('[data-fancybox="gallery"]').fancybox({ buttons: ["slideShow", "thumbs", "fullScreen", "close"], loop: false, protect: true });
    $('[data-fancybox="footer"]').fancybox({ buttons: ["slideShow", "thumbs", "fullScreen", "close"], loop: false, protect: true });
    ...
    var destinationSliderOne = new Swiper(".destination-slider-one", {
        ...
        breakpoints: { 480: { slidesPerView: 2 }, 768: { slidesPerView: 3 }, 992: { slidesPerView: 4 }, 1200: { slidesPerView: 5 } },
    });
    var destinationSliderTwo = new Swiper(".destination-slider-two", {
        ...
        breakpoints: { 480: { slidesPerView: 2 }, 768: { slidesPerView: 3 }, 992: { slidesPerView: 3 }, 1200: { slidesPerView: 4 } },
    });
    var socialSlider = new Swiper(".social-activity-slider", {
        ...
        autoplay: { delay: 15000 },
        pagination: { el: ".testi-pagination", clickable: true },
        breakpoints: { 480: { slidesPerView: 3 }, 768: { slidesPerView: 3 }, 992: { slidesPerView: 4 }, 1200: { slidesPerView: 5 } },
    });
    var testimonialSliderOne = new Swiper(".testimonial-slider-one", {
        ...
        autoplay: { delay: 15000 },
        navigation: { nextEl: ".testi-next", prevEl: ".testi-prev" },
        breakpoints: { 480: { slidesPerView: 1 }, 768: { slidesPerView: 1 }, 992: { slidesPerView: 2 }, 1200: { slidesPerView: 3 } },
    });
    ...
    var testimonialSliderOne = new Swiper(".testimonial-slider-three", {
        ...
        roundLengths: true,
        autoplay: { delay: 15000 },
        navigation: { nextEl: ".testi-next4", prevEl: ".testi-prev4" },
        breakpoints: { 480: { slidesPerView: 1 }, 768: { slidesPerView: 1 }, 992: { slidesPerView: 2 }, 1200: { slidesPerView: 3 } },
    });
    var testimonialSliderOne = new Swiper(".upcoming-tour", {
        ...
        autoplay: { delay: 15000 },
        navigation: { nextEl: ".testi-next4", prevEl: ".testi-prev4" },
        breakpoints: { 480: { slidesPerView: 1 }, 576: { slidesPerView: 2 }, 992: { slidesPerView: 2 }, 1200: { slidesPerView: 3 }, 1400: { slidesPerView: 3 } },
    });
    var gallarySlider = new Swiper(".gallary-slider", {
        ...
        breakpoints: { 480: { slidesPerView: 2 }, 768: { slidesPerView: 2 }, 992: { slidesPerView: 3 }, 1200: { slidesPerView: 3 } },
    });
    ...
    $(".fadeffect").chainFade({ startAt: 0, interval: 300, speed: 700, fx: "fade", distance: 50, direction: "forward", toThe: "top", fixedHeight: false, messages: false, queue: true, ease: "swing", after: function () {} });
})(jQuery);
